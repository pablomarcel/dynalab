"""simulator.ui.nodes.tf_widget

Helper graphics item used to create a *flipped* TF node in NodeGraphQt.

Goal
----
For feedback paths, we want the TF block to have:
...
Notes
-----
- This is a surgical override to minimize risk.
- Horizontal layout only. Vertical layout is untouched.
"""
...
class FlippedPortNodeItem(NodeItem):
    ...
    def _align_ports_horizontal(self, v_offset: float) -> None:
        # Mirror of NodeGraphQt v0.6.44 implementation:
